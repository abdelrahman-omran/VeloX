...
Ultra-lean hackathon kit. Read these before writing code. Skim order: **Exploration (optional) → PRD → Demo → Architecture → API contracts → Brand**.
...
5. **Change brand / theme / logo** → edit [`05-brand.md`](05-brand.md) and files under [`brand/`](brand/).
